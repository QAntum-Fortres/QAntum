...
import { PriceOracle, PricePrediction, ChronosConfig } from './chronos/PriceOracle';
import {
...
import { AtomicTrader, AtomicSwap, AtomicTraderConfig } from './physics/AtomicTrader';
import { ArbitrageOpportunity } from './math/ArbitrageLogic';

// ─── Cognition Components ──────────────────────────────────────────────────────
import { ThoughtChain, Problem, Solution, createThoughtChain } from './cognition/thought-chain';
import { SelfCritique, CritiqueResult, createSelfCritique } from './cognition/self-critique';

// ─── Biometric Stealth ────────────────────────────────────────────────────────
import { BiometricJitter, BiometricProfile } from './biology/biometric-jitter';
...
export class SingularityMarketBridge extends EventEmitter {
  ...
  private async cognitivellyEvaluate(
    ...
    // ── Risk Score ───────────────────────────────────────────────────────
    const riskRatio  = Math.min(opp.riskScore / 100, 1.0);
