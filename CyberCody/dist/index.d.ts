...
import type { CyberCodyConfig, ScanResult, ReconResult, FuzzingResult, FuzzingConfig, VulnerabilitySnapshot, EventHandler, PayloadCategory } from './types/index.js';
import { APIInterceptor, type APIMap } from './modules/api-interceptor.js';
import { BOLATester, type BOLATestReport } from './modules/bola-tester.js';
import { LogicAnalyzer, type LogicAnalysisReport } from './modules/logic-analyzer.js';
import { SurgeonIntegration, type SurgeonReport, type Framework } from './modules/surgeon-integration.js';
import { ShadowAPIDiscovery, type ShadowAPIReport } from './modules/shadow-api-discovery.js';
import { SessionOrchestrator, type UserProfile, type SessionOrchestratorReport, type CrossSessionVulnerability } from './modules/session-orchestrator.js';
import { PIIScanner, type PIIDetection, type PIIScannerReport, type PIICategory, type PIIRiskLevel } from './modules/pii-scanner.js';
import { StealthEngine, type StealthResponse, type StealthLevel, type TimingStrategy, type StealthStats } from './modules/stealth-engine.js';
import { RemediationGenerator, type GeneratedPatch, type RemediationReport } from './modules/remediation-gen.js';
import { VisualPhishingDetector, type PhishingAnalysis, type PhishingReport, type BrandSignature } from './modules/visual-phishing-detector.js';
import { HiddenElementFinder, type HiddenElement, type HiddenElementReport, type ClickjackingVector } from './modules/hidden-element-finder.js';
import { DashboardSync, type SecurityHealthScore, type DashboardSecurityReport, type VulnerabilitySummary } from './modules/dashboard-sync.js';
import { type AttackSurfaceAnalysis } from './modules/predictive-attack-surface.js';
import { type LifecycleResult } from './modules/autonomous-bug-fixer.js';
/**
...
export { HotSwapSelectorEngine } from './modules/hot-swap-selector.js';
export type { SelectorFingerprint, HotSwapResult, HotSwapReport, SelectorMemory } from './modules/hot-swap-selector.js';
export { PredictiveAttackSurface } from './modules/predictive-attack-surface.js';
export type { VulnerabilityTrend, AttackSurfaceAnalysis, VulnerabilityCategory, DependencyRisk } from './modules/predictive-attack-surface.js';
export { AutonomousBugFixer } from './modules/autonomous-bug-fixer.js';
export type { GeneratedPatch as BugPatch, PatchVerification, PullRequestDetails, LifecycleResult } from './modules/autonomous-bug-fixer.js';
