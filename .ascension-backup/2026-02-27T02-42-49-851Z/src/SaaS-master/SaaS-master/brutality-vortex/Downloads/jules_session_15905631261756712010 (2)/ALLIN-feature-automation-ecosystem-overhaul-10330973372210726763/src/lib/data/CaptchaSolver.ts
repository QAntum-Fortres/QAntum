...
export abstract class BaseCaptchaSolver extends EventEmitter {
  ...
  protected log(...args: any[]): void {
    if (this.config.debug) {
      logger.debug('[CaptchaSolver]', ...args);
    }
  }
}
...
export class TwoCaptchaSolver extends BaseCaptchaSolver {
  protected override baseUrl = 'https://2captcha.com';

  protected override async createTask(task: CaptchaTask): Promise<string> {
    const params: any = {
...
export class AntiCaptchaSolver extends BaseCaptchaSolver {
  protected override baseUrl = 'https://api.anti-captcha.com';
...
export class CapMonsterSolver extends BaseCaptchaSolver {
  protected override baseUrl = 'https://api.capmonster.cloud';
