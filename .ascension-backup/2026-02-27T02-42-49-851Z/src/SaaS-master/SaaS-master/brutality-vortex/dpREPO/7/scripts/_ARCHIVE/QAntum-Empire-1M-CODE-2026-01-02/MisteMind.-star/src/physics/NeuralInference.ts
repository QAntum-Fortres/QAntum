 ...
 * 
 * Connects Aeterna to local Ollama AI with RTX 4050 GPU acceleration.
...
export class NeuralInference extends EventEmitter {
    ...
    private buildPromptWithContext(request: InferenceRequest): string {
        ...
        // System context
        parts.push(`[SYSTEM] You are Aeterna AI - an expert software testing and quality assurance assistant.`);
