...
export class SelfHealingSales extends EventEmitter {
  ...
  async generateReport(
    ...
    const report: IssueReport = {
      ...
      downloadUrl: `https://aeterna.io/reports/${reportId}`,
      shareUrl: `https://aeterna.io/share/${reportId}`
    };
  ...
  private generateOffers(issues: DiscoveredIssue[], clientKeyId: string): SalesOffer[] {
    ...
    if (autofixableIssues.length > 0) {
      ...
      offers.push({
        ...
        ctaText: 'Fix Now',
        ctaUrl: `https://aeterna.io/autofix/${clientKeyId}`
      });
    }
    ...
    offers.push({
      ...
      ctaUrl: `https://aeterna.io/test-suite/${clientKeyId}`
    });
    ...
    offers.push({
      ...
      ctaUrl: `https://aeterna.io/monitoring/${clientKeyId}`
    });
    ...
    if (autofixableIssues.length > 0) {
      ...
      offers.push({
        ...
        ctaUrl: `https://aeterna.io/bundle/${clientKeyId}`
      });
    }
