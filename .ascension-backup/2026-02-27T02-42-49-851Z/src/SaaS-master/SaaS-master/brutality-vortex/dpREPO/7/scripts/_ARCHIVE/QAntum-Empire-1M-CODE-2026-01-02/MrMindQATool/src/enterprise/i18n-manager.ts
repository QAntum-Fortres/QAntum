...
export const bg: I18nTranslations = {
  ...
  common: {
    ...
    opened: 'Отворено:',
    initialized: 'Aeterna v23.0.0 UI инициализиран',
...
export const en: I18nTranslations = {
  ...
  common: {
    ...
    warning: 'Warning',
    opened: 'Opened:',
    initialized: 'Aeterna v23.0.0 UI initialized',
...
export const de: I18nTranslations = {
  ...
  common: {
    ...
    warning: 'Warnung',
    opened: 'Geöffnet:',
    initialized: 'Aeterna v23.0.0 UI initialisiert',
...
export const fr: I18nTranslations = {
  ...
  common: {
    ...
    opened: 'Ouvert:',
    initialized: 'Aeterna v23.0.0 UI initialisé',
...
export const cn: I18nTranslations = {
  ...
  common: {
    ...
    warning: '警告',
    opened: '已打开:',
    initialized: 'Aeterna v23.3.0 UI 已初始化',
...
export const jp: I18nTranslations = {
  ...
  common: {
    ...
    warning: '警告',
    opened: '開いた:',
    initialized: 'Aeterna v23.3.0 UI 初期化完了',
...
export class I18nManager {
   ...
   * Example: i18n.get('header.title') returns 'AETERNA'
   */
