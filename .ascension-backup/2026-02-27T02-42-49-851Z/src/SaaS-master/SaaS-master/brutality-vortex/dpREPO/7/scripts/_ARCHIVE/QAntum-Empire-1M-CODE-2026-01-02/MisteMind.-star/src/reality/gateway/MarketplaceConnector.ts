 ...
 * 
 * Marketplace Integration - Automatically lists Aeterna services in AWS
...
const DEFAULT_CONFIG: MarketplaceConnectorConfig = {
  ...
  companyName: 'AETERNA Technologies',
 ...
 * 
 * Automates listing Aeterna services across cloud marketplaces.
 */
export class MarketplaceConnector extends EventEmitter {
  ...
  private buildDeploymentOptions(marketplace: Marketplace): DeploymentOption[] {
    ...
    if (marketplace === 'aws') {
      ...
      options.push({
        optionId: this.generateId('dep'),
        name: 'Aeterna Container (ECS/EKS)',
        type: 'container',
