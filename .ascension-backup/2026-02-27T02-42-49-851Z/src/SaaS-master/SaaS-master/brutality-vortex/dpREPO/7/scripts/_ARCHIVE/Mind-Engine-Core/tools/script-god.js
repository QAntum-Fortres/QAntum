...
const CONFIG = {
    ...
    memoryFile: path.resolve(__dirname, '..', 'AETERNA-LEGACY.json'),
    maxRetries: 3,
    verifyCommands: {
...
class StrategyEngine {
    ...
    executeVersionBump(params, options) {
        ...
        if (from && to) {
            ...
            patterns.push(
                { regex: new RegExp(`"version"\\s*:\\s*"${from}"`, 'g'), replacement: `"version": "1.0.0-AETERNA"` },
...
${c.bright}EXAMPLES:${c.reset}
  ...
  node tools/script-god.js "rename class Aeterna to Aeterna"
  ...
  node tools/script-god.js --execute "update version from 1.0.0-AETERNA-PRIME to 1.0.0"
