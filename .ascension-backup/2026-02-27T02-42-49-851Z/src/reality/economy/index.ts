...
export { LiveWalletManager, liveWalletManager } from './LiveWalletManager';

// ═══════════════════════════════════════════════════════════════════════════
// EMERGENCY KILL SWITCH
// ═══════════════════════════════════════════════════════════════════════════

export { EmergencyKillSwitch, emergencyKillSwitch } from './EmergencyKillSwitch';

// ═══════════════════════════════════════════════════════════════════════════
// ARBITRAGE
// ═══════════════════════════════════════════════════════════════════════════

export { ArbitrageOrchestrator, arbitrageOrchestrator } from './ArbitrageOrchestrator';

export { MarketWatcher, marketWatcher } from './MarketWatcher';
...
║  Exchanges: ${
    Object.keys(config.exchanges)
      .filter((e) => config.exchanges[e])
      .join(', ') || 'None'
  }                                         ║
