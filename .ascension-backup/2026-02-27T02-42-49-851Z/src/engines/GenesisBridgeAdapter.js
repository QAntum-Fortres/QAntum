...
import { DataSourceType, createNeuralCoreMagnet } from './NeuralCoreMagnet.js';
import { MeditationType, createSupremeMeditation } from './SupremeMeditation.js';
// ═══════════════════════════════════════════════════════════════════════════════
// TYPE DEFINITIONS (mirroring OntoGenerator types for integration)
// ═══════════════════════════════════════════════════════════════════════════════
export var AxiomType;
(function (AxiomType) {
...
export class GenesisBridgeAdapter extends EventEmitter {
    ...
    async suggestRealityOptimizations(realityId) {
        ...
        const meditationResult = await this.meditation.meditate(`optimize reality with ${axiomTypes.join(', ')} axioms`, MeditationType.KNOWLEDGE_SYNTHESIS, { depth: 5 });
        const optimizations = [];
...
// FACTORY
// ═══════════════════════════════════════════════════════════════════════════════
export function createGenesisBridgeAdapter(bridgeSystem, config) {
...
//# sourceMappingURL=GenesisBridgeAdapter.js.map