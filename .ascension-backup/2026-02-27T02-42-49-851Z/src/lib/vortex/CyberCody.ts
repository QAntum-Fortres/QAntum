import { semanticFuzzer } from './semantic-fuzzer';
/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * Aeterna - CyberCody CLI
 * ═══════════════════════════════════════════════════════════════════════════════
 *
...
Examples:
  ...
  npx ts - node src / security / cybercody - cli.ts ghost - audit https://example.com --screenshots

  # Full stealth audit with AI annotations
  npx ts - node src / security / cybercody - cli.ts ghost - audit https://example.com \\
--mode safe - hunter \\
--stealth \\
--multi - user \\
--headless=false \\
