...
// ==========================================
// QANTUM AETERNA - PROACTIVE QA AUDITOR
// ==========================================
...
const AETERNA_SMTP_USER = process.env.SMTP_USER || 'your_email@qantum-prime.com';
    ...
    try {
        ...
        if (bugs.length > 0) {
            ...
            await page.evaluate((bugList) => {
                ...
                div.style.backgroundColor = 'rgba(248, 113, 113, 0.9)'; // QAntum Danger
                div.style.color = '#fff';
                ...
                html += '</ul><p style="font-size: 11px; margin-top: 10px;">Audit by QANTUM PRIME</p>';
                div.innerHTML = html;
...
async function sendAuditReport(targetUrl, targetEmail, bugs, videoPath) {
    ...
    const htmlTemplate = `
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #020408; color: #f1f5f9; border-radius: 12px; overflow: hidden; border: 1px solid #1e293b;">
            <div style="background-color: #0b101b; padding: 30px; border-bottom: 1px solid #1e293b; text-align: center;">
                <h1 style="margin: 0; color: #a78bfa; letter-spacing: 2px;">QANTUM <span style="color: #fff;">PRIME</span></h1>
            ...
            <div style="padding: 30px;">
                ...
                <p><strong>QANTUM PRIME</strong> offers a proactive, self-healing network. Our AI doesn't just find bugs; it predicts them by learning from global data streams and neutralizes them before they ever deploy to production.</p>
                <ul>
                ...
                <p>To upgrade your infrastructure to a Sovereign state and ensure these issues never return, initiate your subscription to the QANTUM ecosystem tonight.</p>
    ...
    const mailOptions = {
        from: `"QANTUM PRIME" <${AETERNA_SMTP_USER}>`,
        to: targetEmail,
