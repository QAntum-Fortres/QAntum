...
import { HardwareLock, HardwareLockConfig, getHardwareLock } from './hardware-lock';
import { AntiTamper, AntiTamperConfig, getAntiTamper } from './anti-tamper';
import { SentinelConfig, getSentinelLink } from './sentinel-link';
import { FatalityEngine, FatalityConfig, getFatalityEngine } from './fatality-engine';

// Re-export existing modules
export * from './SecurityTesting';

// Re-export all security modules
export * from './hardware-lock';
export * from './anti-tamper';
export * from './sentinel-link';
export * from './fatality-engine';
