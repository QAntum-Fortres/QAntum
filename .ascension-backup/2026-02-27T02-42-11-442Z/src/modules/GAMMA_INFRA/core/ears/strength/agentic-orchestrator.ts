...
import { generateTraceId, generateSpanId, generateMessageId } from '../utils/id-generator';
...
export class AgenticOrchestrator extends EventEmitter {
  ...
  private updateStats(result: TaskResult): void {
    ...
    this.stats.successRate =
      this.stats.totalTasks > 0 ? this.stats.successfulTasks / this.stats.totalTasks : 0;
