...
async function chatWithGemini(
  ...
  const prompt = `Ти си AETERNA Arbitrage Bot — AI асистент на Wealth Bridge. Отговаряш на български или английски. ${ctx}
...
export async function startArbitrageBotServer() {
  ...
  server.listen(PORT, () => {
    ...
    console.log(`\n╔══════════════════════════════════════════════════════════════╗`);
    console.log(`║  🤖 AETERNA Arbitrage Bot — Port ${PORT}                          ║`);
