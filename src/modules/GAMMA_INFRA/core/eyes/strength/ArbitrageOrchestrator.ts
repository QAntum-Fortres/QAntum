...
╚═══════════════════════════════════════════════════════════════════════════╝
  ...
  private handleNewSpreads(spreads: PriceSpread[]): void {
    ...
    console.log(`[Orchestrator] 📨 Received ${spreads.length} spreads for analysis`);
  ...
  private handleSwapCompleted(swap: AtomicSwap): void {
    ...
    console.log(
      `[Orchestrator] 💰 Trade completed! Profit: $${profit.toFixed(2)} | Capital: $${this.currentCapital.toFixed(2)}`
    );
