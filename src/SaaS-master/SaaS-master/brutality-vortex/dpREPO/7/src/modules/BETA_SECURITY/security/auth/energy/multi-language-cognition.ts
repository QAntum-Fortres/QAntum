...
// ═══════════════════════════════════════════════════════════════════════════════
// Enables Aeterna to understand and execute voice commands in multiple
// languages, with primary focus on Bulgarian (bg) and English (en).
// ═══════════════════════════════════════════════════════════════════════════════

import { IntentType, ExtractedEntity, SemanticAction } from '../../../core/mouth/energy/voice-commander';
