/**
 * ═══════════════════════════════════════════════════════════════════════════════
 * AETERNA CHAT PANEL - THE SOVEREIGN UI
 * ═══════════════════════════════════════════════════════════════════════════════
 * 
 ...
 * @copyright 2026 Aeterna Empire. ЛИЧЕН. НЕ ЗА РАЗПРОСТРАНЕНИЕ.
...
export class AeternaChatPanel implements vscode.WebviewViewProvider {
  public static readonly viewType = 'aeterna.chatView';
...
<body>
  ...
  <div class="chat-container" id="chatContainer">
    ...
    <div class="thinking" id="thinking">
      <div>🧠 Aeterna мисли<span class="thinking-dots"></span></div>
    </div>
  </div>
  ...
  <script>
    ...
    window.addEventListener('message', event => {
      ...
      switch (data.type) {
        ...
        case 'offerApply':
          addMessage('system', '✅ Код готов за прилагане. Използвай Ctrl+Shift+P > "Aeterna: Apply Fix"');
          break;
