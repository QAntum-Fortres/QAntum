 ...
 * ╔═══════════════════════════════════════════════════════════════════════════════╗
 * ║                                                                               ║
 * ║   AETERNA CONTEXT BRIDGE CLI v1.0                                              ║
...
program
  .name('qbridge')
  .description('🧠 AETERNA Context Bridge CLI - Query 52K+ Vectors')
  .version('1.0.0');
...
program
  ...
  .action(async () => {
    ...
    try {
      ...
      console.log(chalk.cyan.bold('  🧠 AETERNA CONTEXT BRIDGE STATUS'));
...
${chalk.cyan.bold('╔═══════════════════════════════════════════════════════════════════════════════╗')}
${chalk.cyan.bold('║                                                                               ║')}
${chalk.cyan.bold('║   🧠 AETERNA CONTEXT BRIDGE CLI                                                ║')}
