 ...
 * ╔═══════════════════════════════════════════════════════════════════════════════╗
 * ║                                                                               ║
 * ║   AETERNA VECTOR SYNC v1.0 - AUTOMATIC DELTA SYNCHRONIZATION                   ║
...
const DEFAULT_CONFIG: SyncConfig = {
  ...
  indexName: process.env.PINECONE_INDEX_NAME || 'aeterna-empire',
...
async function main() {
  ...
  console.log('');
  console.log('🧠 AETERNA VECTOR SYNC ENGINE v1.0');
  console.log('═══════════════════════════════════════════════════════════════════');
  console.log('');
