 ...
 * ║   "Където има слънце, няма тъмнина. Където има AETERNA, няма хаос."                               ║
 * ║                                                                                                  ║
 * ║   CONSOLIDATES:                                                                                  ║
 ...
 * ║                                                                                                  ║
 * ║   © 2025-2026 Aeterna Empire | Dimitar Prodromov | v35.0 - THE SINGULARITY                        ║
 * ╚══════════════════════════════════════════════════════════════════════════════════════════════════╝
 */
...
${CYAN}${BOLD}║                                                                                                  ║${RESET}
${CYAN}${BOLD}║   ${YELLOW}"Където има слънце, няма тъмнина. Където има AETERNA, няма хаос."${CYAN}                            ║${RESET}
${CYAN}${BOLD}║                                                                                                  ║${RESET}
