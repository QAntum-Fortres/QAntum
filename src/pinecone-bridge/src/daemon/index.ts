 ...
 * ║              АВТОНОМНИ ИНТЕЛИГЕНТНИ КОМПОНЕНТИ НА AETERNA                      ║
 * ║                                                                              ║
...
} from './GenesisBridgeAdapter.js';

// ═══════════════════════════════════════════════════════════════════════════════
// AETERNA ORCHESTRATOR - Unified Entry Point
// ═══════════════════════════════════════════════════════════════════════════════

export {
  AeternaOrchestrator,
  createAeternaOrchestrator,
  getAeternaOrchestrator,
  resetGlobalOrchestrator,
  type OrchestratorConfig,
  type OrchestratorStatus,
  type AeternaEvent,
} from './AeternaOrchestrator.js';
